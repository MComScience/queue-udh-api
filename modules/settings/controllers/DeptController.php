...
use app\modules\v1\models\search\TblDeptSearch;
...
/**
 * DeptController implements the CRUD actions for TblDept model.
 */
class DeptController extends Controller
{
    ...
    /**
     * Lists all TblDept models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new TblDeptSearch();
    ...
    /**
     * Displays a single TblDept model.
     * @param string $id
     * @return mixed
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "บันทึกแผนก",
                    'content'=>'<span class="text-success">Create TblDept success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing TblDept model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing TblDept model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TblDept model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the TblDept model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return TblDept the loaded model
