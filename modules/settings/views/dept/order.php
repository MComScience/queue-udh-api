...
<div class="form-group">
    <?= Html::activeLabel($model, 'order_dept', ['label'=>'', 'class'=>'col-sm-2 control-label']) ?>
    <div class="col-sm-8">
        <p>
            <span class="label label-warning">ระบบจะเรียงลำดับการแสดงผล "ปุ่มตัวเลือก" หน้าตู้ Kiosk ตามลำดับที่กำหนด</span>
        </p>
        <?= $form->field($model, 'order_dept',['showLabels'=>false])->widget(SortableInput::classname(), [
            'items' => $items,
            'hideInput' => false,
